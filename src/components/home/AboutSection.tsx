...
const AboutSection = () => {
  ...
  return (
    <section id="about" className="py-12 md:py-20 bg-gradient-to-b from-amber-50 to-maroon-50 relative">
      {/* Decorative elements */}
      ...
      <div className="container mx-auto px-4" id="about-section">
        <div className={cn(
          "text-center max-w-3xl mx-auto mb-10 md:mb-16 transition-all duration-1000 transform",
          isVisible ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"
        )}>
          <h2 className="text-3xl md:text-4xl font-serif font-bold text-maroon-900 mb-3">
            Meet Your Teacher
          </h2>
          <p className="text-base md:text-lg text-gray-600 mb-4">Learn from an experienced performer and dedicated educator</p>
